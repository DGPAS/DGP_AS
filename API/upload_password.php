...
$con = dbconnection();
    ...
    if (isset($_FILES['pictogram1']) && isset($_FILES['pictogram2']) && isset($_FILES['pictogram3']) && isset($_POST['idStudent'])) {
        ...
        $pictogram2 = $_FILES['pictograma']['name'];
        ...
        $tmp_name2 = $_FILES['pictograma']['tmp_name'];
        ...
        $query = "INSERT INTO `passwordStudent`(`idStudent`, `pictogram1`, `pictograma`, `pictogram3`) VALUES (?, ?, ?, ?)";
